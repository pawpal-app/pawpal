      ...
      <main className="max-w-3xl mx-auto px-4 lg:px-8 py-6 lg:py-8">
        <div className="prose prose-sm lg:prose-base max-w-none">
          ...
          <div className="space-y-4 lg:space-y-6">
            ...
            <section>
              <h2 className="text-lg lg:text-xl font-semibold text-[#345045] mb-2 lg:mb-3">2. Service Description</h2>
              <p className="text-sm lg:text-base text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-lg lg:text-xl font-semibold text-[#345045] mb-2 lg:mb-3">3. User Responsibilities</h2>
            ...
            <section>
              <h2 className="text-lg lg:text-xl font-semibold text-[#345045] mb-2 lg:mb-3">4. Medical Disclaimer</h2>
            ...
            <section>
              <h2 className="text-lg lg:text-xl font-semibold text-[#345045] mb-2 lg:mb-3">5. Privacy and Data</h2>
              <p className="text-sm lg:text-base text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-lg lg:text-xl font-semibold text-[#345045] mb-2 lg:mb-3">6. Service Availability</h2>
              <p className="text-sm lg:text-base text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-lg lg:text-xl font-semibold text-[#345045] mb-2 lg:mb-3">7. Limitation of Liability</h2>
              <p className="text-sm lg:text-base text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-lg lg:text-xl font-semibold text-[#345045] mb-2 lg:mb-3">8. Changes to Terms</h2>
              <p className="text-sm lg:text-base text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-lg lg:text-xl font-semibold text-[#345045] mb-2 lg:mb-3">9. Contact Information</h2>
              <p className="text-sm lg:text-base text-gray-700 leading-relaxed">

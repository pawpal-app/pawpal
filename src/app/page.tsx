...
export default function Home() {
  ...
  return (
    <div className="min-h-screen scroll-smooth">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 flex items-center min-h-screen">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full py-12 lg:py-20">
            ...
            <div className="text-center lg:text-left">
              <h1 className="text-4xl lg:text-6xl leading-tight mb-6 text-[#ffffff] font-bold">
                PawPal: Your AI Pet Care Assistant
              </h1>
              <p className="text-xl lg:text-2xl mb-8 max-w-2xl mx-auto lg:mx-0 text-[#ffffff] font-medium">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
                <WaitlistForm variant="hero">
                  <Button
                    className="bg-white text-[#345045] hover:bg-gray-50 border border-gray-300 px-8 py-4 text-lg font-semibold rounded-lg shadow-lg"
                    size="lg"
                  >
                    Get Early Access!
                  </Button>
                ...
                <Button
                  ...
                  className="bg-transparent text-white hover:bg-white/10 border-2 border-white px-8 py-4 text-lg font-semibold rounded-lg"
                  size="lg"
                >
                  Discover PawPal
                </Button>
      ...
      <section id="features" className="py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-[#163031] mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
            {[
              ...
              <div key={index} className="text-center group hover:scale-105 transition-all duration-300">
                <div className="w-20 h-20 bg-white/80 backdrop-blur-sm border border-[#6ba5a8]/30 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-white/90 group-hover:border-[#6ba5a8]/50 group-hover:shadow-xl transition-all duration-300">
                  <span className="text-3xl">{feature.icon}</span>
                </div>
                <h3 className="text-xl font-bold text-[#163031] mb-4">{feature.title}</h3>
      ...
      {/* AI To-Dos Section */}
      <section className="py-16 lg:py-24 bg-gradient-to-br from-[#f8fcfc] to-[#eff3f3]">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">Personalized tasks based on your pet's breed, age, and health status</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-[#66a4a8] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <span className="text-white text-sm">✓</span>
                  </div>
                  <p className="text-gray-700">Swipe interface makes it easy to accept or skip tasks</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-[#66a4a8] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <span className="text-white text-sm">✓</span>
                  </div>
                  <p className="text-gray-700">Adapts to your pet's changing needs over time</p>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">Lock screen notifications that you can't ignore</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-[#66a4a8] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <span className="text-white text-sm">✓</span>
                  </div>
                  <p className="text-gray-700">Follow-up reminders if you miss a task</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-[#66a4a8] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <span className="text-white text-sm">✓</span>
                  </div>
                  <p className="text-gray-700">Smart timing based on your pet's schedule</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">Daily mood and health tracking</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-[#66a4a8] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <span className="text-white text-sm">✓</span>
                  </div>
                  <p className="text-gray-700">Photo uploads and memory keeping</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-[#66a4a8] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <span className="text-white text-sm">✓</span>
                  </div>
                  <p className="text-gray-700">Share with friends or keep private</p>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">24/7 AI assistance for any pet care question</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-[#66a4a8] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <span className="text-white text-sm">✓</span>
                  </div>
                  <p className="text-gray-700">Full chat history for easy reference</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-[#66a4a8] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <span className="text-white text-sm">✓</span>
                  </div>
                  <p className="text-gray-700">Trustworthy responses</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">Multiple pet profiles in one app</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-[#66a4a8] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <span className="text-white text-sm">✓</span>
                  </div>
                  <p className="text-gray-700">Easy switching between pets</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-[#66a4a8] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <span className="text-white text-sm">✓</span>
                  </div>
                  <p className="text-gray-700">Individualized care for each pet</p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
            ...
            <div className="text-center group">
              <div className="relative mb-8">
                <div className="w-20 h-20 bg-white/80 backdrop-blur-sm border border-[#6ba5a8]/30 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-white/90 group-hover:border-[#6ba5a8]/50 group-hover:shadow-xl transition-all duration-300">
                  <span className="text-3xl">📋</span>
                </div>
                <div className="absolute -top-2 -right-2 w-8 h-8 bg-[#2D6063] rounded-full flex items-center justify-center">
                  <span className="text-white font-bold text-lg">1</span>
                </div>
              </div>
              <h3 className="text-xl font-bold text-[#163031] mb-4">Create Your Pet's Profile in Seconds</h3>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-[#163031] mb-4">Swipe Through Smart Suggestions</h3>
              <p className="text-base text-gray-600 leading-relaxed">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-[#163031] mb-4">Stay Organized Automatically</h3>
              <p className="text-base text-gray-600 leading-relaxed">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-[#163031] mb-4">Connect with Friends & Share </h3>
              <p className="text-base text-gray-600 leading-relaxed">
          ...
          <div className="text-center mt-12">
            <WaitlistForm variant="cta">
              <Button
                className="bg-[#2D6063] text-white hover:bg-[#2a3f3a] px-8 py-4 text-lg font-semibold rounded-lg shadow-lg"
                size="lg"
              >
                Start My Pet's Plan
              </Button>
      ...
      <section className="py-16 lg:py-24 bg-[#eff3f3]" id="testimonials">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-[#163031] mb-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">First-time dog owner</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Experienced pet owner</p>
                </div>
              </div>
              <blockquote className="text-gray-800 text-lg leading-relaxed font-medium">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-4xl">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800">Jessica T.</h4>
                    <p className="text-sm text-gray-500">Pet rescue volunteer</p>
                  </div>
                </div>
                <blockquote className="text-gray-800 text-lg leading-relaxed font-medium">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800">Alex M.</h4>
                    <p className="text-sm text-gray-500">Exotic pet owner</p>
                  </div>
                </div>
                <blockquote className="text-gray-800 text-lg leading-relaxed font-medium">
      ...
      {/* Final CTA Section */}
      <section className="py-16 lg:py-24 text-white bg-gradient-to-br from-[#6ba5a8] to-[#2D6063]" id="waitlist">
        <div className="max-w-6xl mx-auto px-4 lg:px-8 text-center">
          <h2 className="text-4xl lg:text-6xl font-bold mb-6">
            Pet Care Made Simple.<br />
            More Time for What Truly Matters.
          </h2>
          <p className="text-xl lg:text-2xl mb-12 text-gray-200 max-w-4xl mx-auto leading-relaxed">
            Join the community of modern pet parents making pet care effortless with PawPal.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <WaitlistForm variant="cta">
              <Button
                className="bg-white text-[#345045] hover:bg-gray-50 px-8 py-4 text-lg font-semibold rounded-lg shadow-lg"
                size="lg"
              >
                Get Early Access
              </Button>
      ...
      <footer className="bg-white py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="text-center text-gray-500 space-y-4">
            <p className="text-sm">Copyright © 2025 PawPal LLC. All rights reserved.</p>
